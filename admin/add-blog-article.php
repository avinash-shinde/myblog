...
<!-- On page head area--> 
  <title>Add New Article - My Blog</title>
  ...
  <div class="content">
      ...
      if(isset($_POST['submit'])){
          ...
          if(!isset($error)){
            try {
                   ...
                   $stmt = $db->prepare('INSERT INTO blog_post (articleTitle,articleDescription,articleContent,catId,cdate) VALUES (:articleTitle, :articleDescription, :articleContent, :catId, :cdate)') ;
      ...
      <form action="" method="post">
          ...
          <textarea name="articleDescription" cols="120" rows="6"><?php if(isset($error)){ echo $_POST['articleDescription'];}?></textarea></h2>
